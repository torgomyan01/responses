...
import { changeProductReplyConfiguration, changeProductSettings } from '../../utils/helpers';
              ...
              <div className="wrapper">
                ...
                <div className="mb-4">
                  <DefaultInputs
                    ...
                    title={<span className="c-grey fs-18 mb-2 d-block">Рекомендуемый артикул</span>}
                    quotation={{
                      text: 'text',
                      title: 'title'
                    }}
                ...
                <div className="mb-4">
                  <DefaultInputs
                    ...
                    title={<span className="c-grey fs-18 mb-2 d-block">Текст рекомендации</span>}
                    quotation={{
                      text: 'text',
                      title: 'title'
                    }}
            ...
            <div className="col-12 mb-5">
              <div className="wrapper">
                <div className="row">
                  ...
                  <div className="col-6">
                    <p className="fs-18 c-grey">Своя подпись</p>
                    <Select
                      className="select-project-settings"
                      selected={printValueSelect(
                        data?.configuration.replyConfiguration.rates['1'].reviewStyle
